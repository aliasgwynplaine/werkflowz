...
pub async fn mesg_service_long_seq(_req: Request<Body>) -> Result<Response<Body>, Infallible> {
...
pub async fn mesg_service_c(_req: Request<Body>) -> Result<Response<Body>, Infallible> {
    let mut e = Envelope::new();
    e.workload = get_2103();
